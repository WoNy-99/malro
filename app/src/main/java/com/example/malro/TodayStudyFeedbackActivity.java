...
public class TodayStudyFeedbackActivity extends AppCompatActivity {

    // XML과 1:1 매칭되는 뷰 (XML에 LineChart id=feedbackChart 가 있어야 합니다)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 4) 점수 배열이 있으면 차트 표시 (없으면 조용히 스킵)
        if (feedbackChart != null && scores != null && scores.length > 0) {
